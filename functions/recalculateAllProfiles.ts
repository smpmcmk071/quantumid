      ...
      try {
        ...
        if (response.data?.success) {
          ...
          await base44.asServiceRole.entities.TeamMember.update(member.id, {
            ...
            life_path_western_vibe: calc.lifePath?.display || '',
            life_path_chaldean: calc.lifePathChaldean?.reduced || 0,
            life_path_chaldean_vibe: calc.lifePathChaldean?.display || '',
            ...
            pythagorean_total: calc.pythagorean?.total || 0,
            chaldean_total: calc.chaldean?.total || 0,
